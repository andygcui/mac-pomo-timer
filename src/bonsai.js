window.addEventListener("DOMContentLoaded", () => {
  ...
  const plantStages = {
    static: {
      0: "assets/bonsai/stage_0/1.png",
      1: "assets/bonsai/stage_1/1.png",
      2: "assets/bonsai/stage_2/1.png",
      3: "assets/bonsai/image/bonsai.png"
    },
    focus: {
      0: [
        "assets/bonsai/stage_0/1.png"
      ],
      1: [
        "assets/bonsai/stage_1/1.png",
        "assets/bonsai/stage_1/2.png"
      ],
      2: [
        "assets/bonsai/stage_2/1.png",
        "assets/bonsai/stage_2/2.png"
      ]
    },
    grow: {
      0: [
        "assets/bonsai/stage_0_grow/1.png",
        "assets/bonsai/stage_0_grow/2.png"
      ],
      1: [
        "assets/bonsai/stage_1_grow/1.png",
        "assets/bonsai/stage_1_grow/2.png"
      ],
      2: [
        "assets/bonsai/stage_2_grow/1.png",
        "assets/bonsai/stage_2_grow/2.png"
      ]
    },
    final: [
      "assets/bonsai/stage_3/1.png",
      "assets/bonsai/stage_3/2.png"
    ]
  };
  ...
  function resetPlant() {
    ...
    showStaticImage();
    messageEl.textContent = "A new bonsai is ready to grow! \n ";
  ...
  function startFocusSession() {
    ...
    timer = setInterval(() => {
      ...
      if (currentTime <= 0) {
        ...
        if (stage < 3) {
          if (stage === 2) {
            messageEl.textContent = "Focus done! To start a long break, water your bonsai!";
            new Notification("Long break time!", { body: "Water your bonsai" });
          } else {
            messageEl.textContent = "Focus done! To start a short break, water your bonsai!";
            new Notification("Short break time!", { body: "Water your bonsai" });
          }
      ...
      if (currentTime <= 0) {
        ...
        if (stage < 3) {
          ...
          if (stage < 3) {
            ...
            applyGrowthAnimation().then(() => {
              messageEl.textContent = "Your bonsai has grown! Click Start to focus again. \n ";
