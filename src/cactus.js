window.addEventListener("DOMContentLoaded", () => {
  ...
  const plantStages = {
    static: {
      0: "assets/cactus/stage_0/1.png",
      1: "assets/cactus/stage_1/1.png",
      2: "assets/cactus/stage_2/1.png",
      3: "assets/cactus/image/cactus.png"
    },
    focus: {
      0: [
        "assets/cactus/stage_0/1.png"
      ],
      1: [
        "assets/cactus/stage_1/1.png",
        "assets/cactus/stage_1/2.png"
      ],
      2: [
        "assets/cactus/stage_2/1.png",
        "assets/cactus/stage_2/2.png"
      ]
    },
    grow: {
      0: [
        "assets/cactus/stage_0_grow/1.png",
        "assets/cactus/stage_0_grow/2.png"
      ],
      1: [
        "assets/cactus/stage_1_grow/1.png",
        "assets/cactus/stage_1_grow/2.png"
      ],
      2: [
        "assets/cactus/stage_2_grow/1.png",
        "assets/cactus/stage_2_grow/2.png"
      ]
    },
    final: [
      "assets/cactus/stage_3/1.png",
      "assets/cactus/stage_3/2.png"
    ]
  };
  ...
  function resetPlant() {
    ...
    showStaticImage();
    messageEl.textContent = "A new cactus is ready to grow! \n ";
  ...
  function startFocusSession() {
    ...
    timer = setInterval(() => {
      ...
      if (currentTime <= 0) {
        ...
        if (stage < 3) {
          if (stage === 2) {
            messageEl.textContent = "Focus done! To start a long break, water your cactus!";
            new Notification("Long break time!", { body: "Water your cactus" });
          } else {
            messageEl.textContent = "Focus done! To start a short break, water your cactus!";
            new Notification("Short break time!", { body: "Water your cactus" });
          }
          startBtn.textContent = "Start another focus \n";
          plantStage.style.cursor = "pointer";
          showStaticImage(true);
        } else {
          messageEl.textContent = "Your cactus is fully grown! \n ";
      ...
      if (currentTime <= 0) {
        ...
        if (stage < 3) {
          ...
          if (stage < 3) {
            ...
            applyGrowthAnimation().then(() => {
              messageEl.textContent = "Your cactus has grown! Click Start to focus again. \n ";
