window.addEventListener("DOMContentLoaded", () => {
  ...
  const plantStages = {
    static: {
      0: "assets/bamboo/stage_0/1.png",
      1: "assets/bamboo/stage_1/1.png",
      2: "assets/bamboo/stage_2/1.png",
      3: "assets/bamboo/image/bamboo.png"
    },
    focus: {
      0: [
        "assets/bamboo/stage_0/1.png"
      ],
      1: [
        "assets/bamboo/stage_1/1.png",
        "assets/bamboo/stage_1/2.png"
      ],
      2: [
        "assets/bamboo/stage_2/1.png",
        "assets/bamboo/stage_2/2.png"
      ]
    },
    grow: {
      0: [
        "assets/bamboo/stage_0_grow/1.png",
        "assets/bamboo/stage_0_grow/2.png"
      ],
      1: [
        "assets/bamboo/stage_1_grow/1.png",
        "assets/bamboo/stage_1_grow/2.png"
      ],
      2: [
        "assets/bamboo/stage_2_grow/1.png",
        "assets/bamboo/stage_2_grow/2.png"
      ]
    },
    final: [
      "assets/bamboo/stage_3/1.png",
      "assets/bamboo/stage_3/2.png"
    ]
  };
  ...
  function resetPlant() {
    ...
    showStaticImage();
    messageEl.textContent = "A new bamboo is ready to grow! \n ";
  ...
  function startFocusSession() {
    ...
    timer = setInterval(() => {
      ...
      if (currentTime <= 0) {
        ...
        if (stage < 3) {
          if (stage === 2) {
            messageEl.textContent = "Focus done! To start a long break, water your bamboo!";
            new Notification("Long break time!", { body: "Water your bamboo" });
          } else {
            messageEl.textContent = "Focus done! To start a short break, water your bamboo!";
            new Notification("Short break time!", { body: "Water your bamboo" });
          }
      ...
      if (currentTime <= 0) {
        ...
        if (stage < 3) {
          ...
          if (stage < 3) {
            ...
            applyGrowthAnimation().then(() => {
              messageEl.textContent = "Your bamboo has grown! Click Start to focus again. \n ";
